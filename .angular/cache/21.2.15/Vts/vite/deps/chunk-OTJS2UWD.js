  ...
  tryLoginCodeFlow(options = null) {
    return __async(this, null, function* () {
      ...
      if (!options.preventClearHashAfterLogin) {
        const href = location.origin + location.pathname + location.search.replace(/code=[^&$]*/, "").replace(/scope=[^&$]*/, "").replace(/session_state=[^&$]*/, "").replace(/state=[^&$]*/, "").replace(/^\?&/, "?").replace(/&$/, "").replace(/^\?$/, "").replace(/&+/g, "&").replace(/\?&/, "?").replace(/\?$/, "") + location.hash;
...
//# sourceMappingURL=chunk-OTJS2UWD.js.map
