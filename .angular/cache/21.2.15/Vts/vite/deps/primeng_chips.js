...
function Chips_li_3_span_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r2.field ? ctx_r2.resolveFieldData(item_r2, ctx_r2.field) : item_r2);
  }
}
function Chips_li_3_ng_container_4_TimesCircleIcon_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Chips_li_3_ng_container_4_TimesCircleIcon_1_Template_TimesCircleIcon_click_0_listener($event) {
      ...
      const ctx_r2 = ɵɵnextContext();
      return ɵɵresetView(ctx_r2.removeItem($event, i_r5));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function Chips_li_3_ng_container_4_span_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("data-pc-section", "removeTokenIcon")("aria-hidden", true);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r2.removeTokenIconTemplate);
  }
}
function Chips_li_3_ng_container_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r2.removeTokenIconTemplate);
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r2.removeTokenIconTemplate);
  }
}
function Chips_li_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Chips_li_3_Template_li_click_0_listener($event) {
      ...
      const item_r2 = ɵɵrestoreView(_r1).$implicit;
      const ctx_r2 = ɵɵnextContext();
      return ɵɵresetView(ctx_r2.onItemContextMenu($event, item_r2));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext();
    ɵɵproperty("ngClass", ɵɵpureFunction1(12, _c5, ctx_r2.focusedIndex === i_r5));
    ɵɵattribute("id", ctx_r2.id + "_chips_item_" + i_r5)("ariaLabel", item_r2)("aria-selected", true)("aria-setsize", ctx_r2.value.length)("aria-posinset", i_r5 + 1)("data-p-focused", ctx_r2.focusedIndex === i_r5)("data-pc-section", "token");
    ɵɵadvance(2);
    ɵɵproperty("ngTemplateOutlet", ctx_r2.itemTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(14, _c6, item_r2));
    ɵɵadvance();
