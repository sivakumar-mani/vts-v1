...
var SignaturePad = class _SignaturePad {
  constructor(canvas, options = {}) {
    ...
    if (this.throttle) {
      this._strokeMoveUpdate = throttle(_SignaturePad.prototype._strokeUpdate, this.throttle);
    } else {
      this._strokeMoveUpdate = _SignaturePad.prototype._strokeUpdate;
    }
...
var signature_pad_m_default = SignaturePad;
export {
  signature_pad_m_default as default
};
