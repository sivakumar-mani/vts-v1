...
function ToastItem_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.headlessTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c4, ctx_r0.message, ctx_r0.onCloseIconClick));
  }
}
function ToastItem_ng_template_3_ng_container_1_span_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMap("p-toast-message-icon pi " + ctx_r0.message.icon);
  }
}
...
function ToastItem_ng_template_3_ng_container_1_span_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute("aria-hidden", true)("data-pc-section", "icon");
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r0.message.severity === "success");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.message.severity === "info");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.message.severity === "error");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.message.severity === "warn");
  }
}
function ToastItem_ng_template_3_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r0.message.summary);
    ɵɵadvance();
...
function ToastItem_ng_template_3_button_3_span_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(3);
    ɵɵclassMap("pt-1 text-base p-toast-message-icon pi " + ctx_r0.message.closeIcon);
  }
}
...
function ToastItem_ng_template_3_button_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵattribute("aria-label", ctx_r0.closeAriaLabel)("data-pc-section", "closebutton");
    ɵɵadvance();
...
function ToastItem_ng_template_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵproperty("ngClass", ctx_r0.message == null ? null : ctx_r0.message.contentStyleClass);
    ɵɵattribute("data-pc-section", "content");
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.template);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.template)("ngTemplateOutletContext", ɵɵpureFunction1(6, _c5, ctx_r0.message));
    ɵɵadvance();
    ɵɵproperty("ngIf", (ctx_r0.message == null ? null : ctx_r0.message.closable) !== false);
  }
}
...
var ToastItem = class _ToastItem {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ToastItem_Template(rf, ctx) {
      ...
      if (rf & 2) {
        const notHeadless_r3 = ɵɵreference(4);
        ...
        ɵɵadvance(2);
        ɵɵproperty("ngIf", ctx.headlessTemplate)("ngIfElse", notHeadless_r3);
      }
    },
