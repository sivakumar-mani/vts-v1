...
function Listbox_div_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(2);
    ɵɵproperty("ngTemplateOutlet", ctx_r0.headerTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c9, ctx_r0.modelValue(), ctx_r0.visibleOptions()));
  }
}
...
function Listbox_div_4_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(8, _c10, ctx_r0.disabled || ctx_r0.toggleAllDisabled));
    ɵɵadvance();
    ɵɵattribute("data-p-hidden-accessible", true);
    ɵɵadvance();
    ɵɵproperty("disabled", ctx_r0.disabled || ctx_r0.toggleAllDisabled);
    ɵɵattribute("checked", ctx_r0.allSelected())("aria-label", ctx_r0.toggleAllAriaLabel);
    ɵɵadvance(2);
    ɵɵproperty("ngClass", ɵɵpureFunction3(10, _c11, ctx_r0.allSelected(), ctx_r0.headerCheckboxFocus, ctx_r0.disabled || ctx_r0.toggleAllDisabled));
    ɵɵattribute("aria-checked", ctx_r0.allSelected());
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.allSelected());
  }
}
...
function Listbox_div_4_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.filterTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(2, _c12, ctx_r0.filterOptions));
  }
}
...
function Listbox_div_4_ng_template_3_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("input", function Listbox_div_4_ng_template_3_div_0_Template_input_input_1_listener($event) {
      ...
      ɵɵrestoreView(_r3);
      const ctx_r0 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r0.onFilterFocus($event));
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(3);
    ɵɵadvance();
    ɵɵproperty("value", ctx_r0._filterValue() || "")("disabled", ctx_r0.disabled)("tabindex", !ctx_r0.disabled && !ctx_r0.focused ? ctx_r0.tabindex : -1);
    ɵɵattribute("aria-owns", ctx_r0.id + "_list")("aria-activedescendant", ctx_r0.focusedOptionId)("placeholder", ctx_r0.filterPlaceHolder)("aria-label", ctx_r0.ariaFilterLabel);
    ɵɵadvance(2);
...
function Listbox_div_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.filterTemplate)("ngIfElse", builtInFilterElement_r4);
  }
}
...
function Listbox_p_scroller_7_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵnextContext(2);
    const buildInItems_r8 = ɵɵreference(10);
    ɵɵproperty("ngTemplateOutlet", buildInItems_r8)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c9, items_r6, scrollerOptions_r7));
  }
}
...
function Listbox_p_scroller_7_ng_container_3_ng_template_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext(3);
    ɵɵproperty("ngTemplateOutlet", ctx_r0.loaderTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(2, _c12, scrollerOptions_r9));
  }
}
...
function Listbox_p_scroller_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵstyleMap(ɵɵpureFunction1(9, _c13, ctx_r0.scrollHeight));
    ɵɵproperty("items", ctx_r0.visibleOptions())("itemSize", ctx_r0.virtualScrollItemSize)("autoSize", true)("lazy", ctx_r0.lazy)("options", ctx_r0.virtualScrollOptions)("tabindex", ctx_r0.scrollerTabIndex);
    ɵɵadvance(3);
    ɵɵproperty("ngIf", ctx_r0.loaderTemplate);
  }
}
...
function Listbox_ng_container_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const buildInItems_r8 = ɵɵreference(10);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", buildInItems_r8)("ngTemplateOutletContext", ɵɵpureFunction2(3, _c9, ctx_r0.visibleOptions(), ɵɵpureFunction0(2, _c14)));
  }
}
function Listbox_ng_template_9_ng_template_2_ng_container_0_span_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const option_r11 = ɵɵnextContext(2).$implicit;
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r0.getOptionGroupLabel(option_r11.optionGroup));
  }
}
...
function Listbox_ng_template_9_ng_template_2_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const option_r11 = ctx_r11.$implicit;
    const i_r13 = ctx_r11.index;
    const scrollerOptions_r14 = ɵɵnextContext().options;
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(5, _c13, scrollerOptions_r14.itemSize + "px"));
    ɵɵattribute("id", ctx_r0.id + "_" + ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14));
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.groupTemplate);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.groupTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(7, _c15, option_r11.optionGroup));
  }
}
...
function Listbox_ng_template_9_ng_template_2_ng_container_1_div_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const option_r11 = ɵɵnextContext(2).$implicit;
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(3, _c10, ctx_r0.disabled || ctx_r0.isOptionDisabled(option_r11)));
    ɵɵadvance();
    ɵɵproperty("ngClass", ɵɵpureFunction1(5, _c18, ctx_r0.isSelected(option_r11)));
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.isSelected(option_r11));
  }
}
function Listbox_ng_template_9_ng_template_2_ng_container_1_span_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r0.getOptionLabel(option_r11));
  }
}
...
function Listbox_ng_template_9_ng_template_2_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function Listbox_ng_template_9_ng_template_2_ng_container_1_Template_li_click_1_listener($event) {
      ...
      const scrollerOptions_r14 = ɵɵnextContext().options;
      const ctx_r0 = ɵɵnextContext();
      return ɵɵresetView(ctx_r0.onOptionSelect($event, option_r11, ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14)));
    })("dblclick", function Listbox_ng_template_9_ng_template_2_ng_container_1_Template_li_dblclick_1_listener($event) {
      ɵɵrestoreView(_r15);
      const option_r11 = ɵɵnextContext().$implicit;
      const ctx_r0 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r0.onOptionDoubleClick($event, option_r11));
      ...
      const scrollerOptions_r14 = ɵɵnextContext().options;
      const ctx_r0 = ɵɵnextContext();
      return ɵɵresetView(ctx_r0.onOptionMouseDown($event, ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14)));
    })("mouseenter", function Listbox_ng_template_9_ng_template_2_ng_container_1_Template_li_mouseenter_1_listener($event) {
      ɵɵrestoreView(_r15);
      const i_r13 = ɵɵnextContext().index;
      const scrollerOptions_r14 = ɵɵnextContext().options;
      const ctx_r0 = ɵɵnextContext();
      return ɵɵresetView(ctx_r0.onOptionMouseEnter($event, ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14)));
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(12, _c13, scrollerOptions_r14.itemSize + "px"))("ngClass", ɵɵpureFunction3(14, _c16, ctx_r0.isSelected(option_r11), ctx_r0.focusedOptionIndex() === ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14), ctx_r0.isOptionDisabled(option_r11)));
    ɵɵattribute("id", ctx_r0.id + "_" + ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14))("aria-label", ctx_r0.getOptionLabel(option_r11))("aria-selected", ctx_r0.isSelected(option_r11))("aria-disabled", ctx_r0.isOptionDisabled(option_r11))("aria-setsize", ctx_r0.ariaSetSize)("ariaPosInset", ctx_r0.getAriaPosInset(ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14)));
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.checkbox && ctx_r0.multiple);
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.itemTemplate);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r0.itemTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(18, _c17, option_r11, ctx_r0.getOptionIndex(i_r13, scrollerOptions_r14)));
  }
}
function Listbox_ng_template_9_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngIf", ctx_r0.isOptionGroup(option_r11));
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.isOptionGroup(option_r11));
  }
}
...
function Listbox_ng_template_9_li_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.emptyFilterTemplate && !ctx_r0.emptyTemplate)("ngIfElse", ctx_r0.emptyFilter);
    ɵɵadvance();
...
function Listbox_ng_template_9_li_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.emptyTemplate)("ngIfElse", ctx_r0.empty);
    ɵɵadvance();
...
function Listbox_ng_template_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext();
    ɵɵproperty("tabindex", -1)("ngClass", scrollerOptions_r14.contentStyleClass)("ngStyle", scrollerOptions_r14.contentStyle);
    ɵɵattribute("aria-multiselectable", true)("aria-activedescendant", ctx_r0.focused ? ctx_r0.focusedOptionId : void 0)("aria-label", ctx_r0.ariaLabel)("aria-multiselectable", ctx_r0.multiple)("aria-disabled", ctx_r0.disabled);
    ɵɵadvance(2);
    ɵɵproperty("ngForOf", items_r16);
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.hasFilter() && ctx_r0.isEmpty());
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.hasFilter() && ctx_r0.isEmpty());
  }
}
...
function Listbox_div_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance(2);
    ɵɵproperty("ngTemplateOutlet", ctx_r0.footerTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(2, _c9, ctx_r0.modelValue(), ctx_r0.visibleOptions()));
  }
}
...
function Listbox_span_12_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵadvance();
    ɵɵtextInterpolate1(" ", ctx_r0.selectedMessageText, " ");
  }
}
function Listbox_span_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r0.hasEmptyMessage());
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r0.hasEmptyMessage());
  }
}
...
var Listbox = class _Listbox {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function Listbox_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, Header, 5)(dirIndex, Footer, 5)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
