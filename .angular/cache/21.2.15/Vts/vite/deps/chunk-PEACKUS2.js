...
var transformFilter = function(_a) {
  ...
  var itemProp = typedGetter(isFunction(field) ? field : getter(field, true), value2, ignoreCase, operator);
...
var groupBy = function(data, descriptors, transformers, originalData) {
  ...
  if (isPresent(descriptor.dir) || isPresent(descriptor.compare)) {
    var userCompare_1 = descriptor.compare;
    var comparer = composeSortDescriptors([{
      field: "value",
      dir: descriptor.dir,
      compare: userCompare_1 ? function(a, b) {
        return userCompare_1(a.value, b.value);
      } : void 0
    }]);
...
//# sourceMappingURL=chunk-PEACKUS2.js.map
