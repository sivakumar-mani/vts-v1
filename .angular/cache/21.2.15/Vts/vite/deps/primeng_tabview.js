...
function TabView_button_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function TabView_button_3_Template_button_click_0_listener() {
      ...
      return ɵɵresetView(ctx_r1.navBackward());
    });
...
function TabView_ng_template_8_li_0_ng_container_2_span_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", tab_r4.leftIcon);
  }
}
...
function TabView_ng_template_8_li_0_ng_container_2_span_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const tab_r4 = ɵɵnextContext(3).$implicit;
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", tab_r4.leftIconTemplate);
  }
}
function TabView_ng_template_8_li_0_ng_container_2_span_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const tab_r4 = ɵɵnextContext(3).$implicit;
    ɵɵproperty("ngClass", tab_r4.rightIcon);
  }
}
...
function TabView_ng_template_8_li_0_ng_container_2_span_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const tab_r4 = ɵɵnextContext(3).$implicit;
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", tab_r4.rightIconTemplate);
  }
}
function TabView_ng_template_8_li_0_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", tab_r4.leftIcon && !tab_r4.leftIconTemplate);
    ɵɵadvance();
    ɵɵproperty("ngIf", tab_r4.leftIconTemplate);
    ɵɵadvance(2);
    ɵɵtextInterpolate(tab_r4.header);
    ɵɵadvance();
    ɵɵproperty("ngIf", tab_r4.rightIcon && !tab_r4.rightIconTemplate);
    ɵɵadvance();
    ɵɵproperty("ngIf", tab_r4.rightIconTemplate);
  }
}
...
function TabView_ng_template_8_li_0_ng_container_4_TimesIcon_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function TabView_ng_template_8_li_0_ng_container_4_TimesIcon_1_Template_TimesIcon_click_0_listener($event) {
      ...
      const tab_r4 = ɵɵnextContext(3).$implicit;
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.close($event, tab_r4));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function TabView_ng_template_8_li_0_ng_container_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const tab_r4 = ɵɵnextContext(2).$implicit;
    ɵɵadvance();
    ɵɵproperty("ngIf", !tab_r4.closeIconTemplate);
    ɵɵadvance();
    ɵɵproperty("ngIf", tab_r4.closeIconTemplate);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", tab_r4.closeIconTemplate);
  }
}
function TabView_ng_template_8_li_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function TabView_ng_template_8_li_0_Template_a_click_1_listener($event) {
      ...
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.open($event, tab_r4));
    })("keydown", function TabView_ng_template_8_li_0_Template_a_keydown_1_listener($event) {
      ɵɵrestoreView(_r3);
      const tab_r4 = ɵɵnextContext().$implicit;
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onTabKeyDown($event, tab_r4));
    });
  ...
  if (rf & 2) {
    ...
    const tab_r4 = ctx_r5.$implicit;
    const i_r7 = ctx_r5.index;
    const ctx_r1 = ɵɵnextContext();
    ɵɵclassMap(tab_r4.headerStyleClass);
    ɵɵproperty("ngClass", ɵɵpureFunction2(19, _c8, tab_r4.selected, tab_r4.disabled))("ngStyle", tab_r4.headerStyle);
    ɵɵattribute("data-p-disabled", tab_r4.disabled);
    ɵɵadvance();
    ɵɵproperty("pTooltip", tab_r4.tooltip)("tooltipPosition", tab_r4.tooltipPosition)("positionStyle", tab_r4.tooltipPositionStyle)("tooltipStyleClass", tab_r4.tooltipStyleClass);
    ɵɵattribute("id", ctx_r1.getTabHeaderActionId(tab_r4.id))("aria-controls", ctx_r1.getTabContentId(tab_r4.id))("aria-selected", tab_r4.selected)("tabindex", tab_r4.disabled || !tab_r4.selected ? "-1" : ctx_r1.tabindex)("aria-disabled", tab_r4.disabled)("data-pc-index", i_r7)("data-pc-section", "headeraction");
    ɵɵadvance();
    ɵɵproperty("ngIf", !tab_r4.headerTemplate);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", tab_r4.headerTemplate);
    ɵɵadvance();
    ɵɵproperty("ngIf", tab_r4.closable);
  }
}
...
function TabView_button_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function TabView_button_11_Template_button_click_0_listener() {
      ɵɵrestoreView(_r8);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.navForward());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵattribute("tabindex", ctx_r1.tabindex)("aria-label", ctx_r1.nextButtonAriaLabel);
    ɵɵadvance(2);
...
var TabView = class _TabView {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function TabView_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, TabPanel, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
    ...
    viewQuery: function TabView_Query(rf, ctx) {
      if (rf & 1) {
        ɵɵviewQuery(_c1, 5)(_c2, 5)(_c3, 5)(_c4, 5)(_c5, 5)(_c6, 5);
      }
      if (rf & 2) {
        let _t;
