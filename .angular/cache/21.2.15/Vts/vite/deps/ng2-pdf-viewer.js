        ...
        (() => {
          ...
          var __webpack_modules__ = [
            ...
            ((__unused_webpack_module, exports, __w_pdfjs_require__) => {
              ...
              function _fetchDocument(worker2, source, pdfDataRangeTransport, docId) {
                return __async(this, null, function* () {
                  ...
                  const workerId = yield worker2.messageHandler.sendWithPromise("GetDocRequest", {
                    docId,
                    apiVersion: "2.14.305",
                    source: {
                      data: source.data,
              ...
              class PDFWorker {
                ...
                static get _setupFakeWorkerGlobal() {
                  const loader = () => __async(this, null, function* () {
                    ...
                    yield (0, _display_utils.loadScript)(this.workerSrc);
            ...
            ((__unused_webpack_module2, exports2, __w_pdfjs_require__2) => {
              ...
              function fetchData(url, asTypedArray = false) {
                return __async(this, null, function* () {
                  if (isValidFetchUrl(url, document.baseURI)) {
                    ...
                    return asTypedArray ? new Uint8Array(yield response.arrayBuffer()) : (0, _util2.stringToBytes)(yield response.text());
                  }
          ...
          var __webpack_modules__2 = [
            ...
            ((__unused_webpack_module2, exports3, __w_pdfjs_require__3) => {
              ...
              class AnnotationLayerBuilder {
                ...
                render(viewport, intent = "display") {
                  return __async(this, null, function* () {
                    const [annotations, hasJSActions = false, fieldObjects = null] = yield Promise.all([this.pdfPage.getAnnotations({
                      intent
            ...
            ((__unused_webpack_module2, exports3) => {
              ...
              const NullL10n = {
                ...
                get(_0) {
                  return __async(this, arguments, function* (key, args = null, fallback = getL10nFallback(key, args)) {
            ...
            ((__unused_webpack_module2, exports3, __w_pdfjs_require__3) => {
              ...
              exports3.LinkTarget = LinkTarget2;
              function addLinkAttributes(link, {
                ...
                let targetStr = "";
                switch (target) {
                  case LinkTarget2.NONE:
                    break;
                  case LinkTarget2.SELF:
                    targetStr = "_self";
                    break;
                  case LinkTarget2.BLANK:
                    targetStr = "_blank";
                    break;
                  case LinkTarget2.PARENT:
                    targetStr = "_parent";
                    break;
                  case LinkTarget2.TOP:
                    targetStr = "_top";
                    break;
                }
              ...
              class PDFLinkService2 {
                ...
                addLinkAttributes(link, url, newWindow = false) {
                  addLinkAttributes(link, {
                    url,
                    target: newWindow ? LinkTarget2.BLANK : this.externalLinkTarget,
            ...
            ((__unused_webpack_module2, exports3, __w_pdfjs_require__3) => {
              ...
              class PDFSinglePageViewer2 extends _base_viewer.BaseViewer {
                _resetView() {
                  super._resetView();
              ...
              exports3.PDFSinglePageViewer = PDFSinglePageViewer2;
            }),
            /* 11 */
            /***/
            ((__unused_webpack_module2, exports3, __w_pdfjs_require__3) => {
              ...
              class BaseViewer {
                ...
                setDocument(pdfDocument) {
                  ...
                  Promise.all([firstPagePromise, permissionsPromise]).then(([firstPdfPage, permissions]) => {
                    ...
                    this.#onePageRenderedOrForceFetch().then(() => __async(this, null, function* () {
                      if (this.findController) {
            ...
            ((__unused_webpack_module2, exports3, __w_pdfjs_require__3) => {
              ...
              class PDFPageView {
                ...
                draw() {
                  ...
                  const finishPaintTask = (error = null) => __async(this, null, function* () {
            ...
            ((__unused_webpack_module2, exports3, __w_pdfjs_require__3) => {
              ...
              class GenericL10n {
                ...
                get(_0) {
                  return __async(this, arguments, function* (key, args = null, fallback = (0, _l10n_utils.getL10nFallback)(key, args)) {
                    const l10n = yield this._ready;
              ...
              class PDFScriptingManager {
                ...
                setDocument(pdfDocument) {
                  return __async(this, null, function* () {
                    ...
                    this._internalEvents.set("pagesdestroy", (event) => __async(this, null, function* () {
                      yield this._dispatchPageClose(this._pdfViewer.currentPageNumber);
                      yield this._scripting?.dispatchEventInSandbox({
                        id: "doc",
                        name: "WillClose"
                      });
                    ...
                    try {
                      const docProperties = yield this._getDocProperties();
                      if (pdfDocument !== this._pdfDocument) {
                        return;
                      }
                      yield this._scripting.createSandbox({
                        objects,
                        calculationOrder,
                        appInfo: {
                        ...
                        docInfo: __spreadProps(__spreadValues({}, docProperties), {
                          actions: docActions
                        })
                      });
                    ...
                    yield this._dispatchPageOpen(this._pdfViewer.currentPageNumber, true);
                    Promise.resolve().then(() => {
                      if (pdfDocument === this._pdfDocument) {
                        this._ready = true;
                      }
                    ...
                    if (!id) {
                      switch (command) {
                        ...
                        case "page-num":
                          ...
                          break;
                        case "print":
                          yield this._pdfViewer.pagesPromise;
                ...
                _destroyScripting() {
                  return __async(this, null, function* () {
                    ...
                    if (this._closeCapability) {
                      yield Promise.race([this._closeCapability.promise, new Promise((resolve) => {
                    ...
                    this._pdfDocument = null;
                    try {
                      yield this._scripting.destroySandbox();
                    } catch (ex) {
                    }
                    for (const [name, listener] of this._internalEvents) {
...
var PDFJS = __toESM(require_pdf(), 1);
var PDFJSViewer = __toESM(require_pdf_viewer(), 1);
...
var PdfViewerComponent = class _PdfViewerComponent {
  ...
  initPDFServices() {
    this.pdfLinkService = new PDFJSViewer.PDFLinkService(__spreadValues({
      eventBus: this.eventBus
...
PdfViewerComponent.CSS_UNITS = 96 / 72;
PdfViewerComponent.BORDER_WIDTH = 9;
PdfViewerComponent.ɵfac = function PdfViewerComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || PdfViewerComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
};
PdfViewerComponent.ɵcmp = ɵɵdefineComponent({
