...
@Component({
  standalone: false,
  selector: 'app-judis-court-record',
  templateUrl: './judis-court-record.component.html',
  styleUrls: ['./judis-court-record.component.css']
})
export class JudisCourtRecordComponent implements OnInit {
  nFlag = false;
