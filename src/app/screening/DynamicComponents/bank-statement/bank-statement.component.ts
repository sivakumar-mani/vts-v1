...
nFlag = false;
  ...
  ngOnInit() {
    ...
    // if(this.mainForm.get(this.formgroupName).get('statementTo')?.value) {
    //   const val =  new Date(this.mainForm.get(this.formgroupName).get('statementTo')?.value);
    //   this.mainForm.get(this.formgroupName).get('statementTo')?.setValue(new DatePipe('en-Us').transform(val, 'dd/MMM/yyyy'));
    //   this.mainForm.get(this.formgroupName).get('statementTo')?.value.toUpperCase();
    // } 
    // if(this.mainForm.get(this.formgroupName).get('statementFrom')?.value) {
    //   const val =  new Date(this.mainForm.get(this.formgroupName).get('statementFrom')?.value);
    //   this.mainForm.get(this.formgroupName).get('statementFrom')?.setValue(new DatePipe('en-Us').transform(val, 'dd/MMM/yyyy'));
    //   this.mainForm.get(this.formgroupName).get('statementFrom')?.value.toUpperCase();
    // }
  }
