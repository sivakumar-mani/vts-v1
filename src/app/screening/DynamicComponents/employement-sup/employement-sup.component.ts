...
@Component({
  standalone: false,
  selector: 'app-employement-sup',
  templateUrl: './employement-sup.component.html',
  styleUrls: ['./employement-sup.component.css']
})
export class EmployementSupComponent implements OnInit, OnChanges {
  compName: any;
