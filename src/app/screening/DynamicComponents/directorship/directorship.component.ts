...
@Component({
  standalone: false,
  selector: 'app-directorship',
  templateUrl: './directorship.component.html',
  styleUrls: ['./directorship.component.css']
})
export class DirectorshipComponent implements OnInit {
