...
@Component({
  standalone: false,
  selector: 'app-company-site-visit',
  templateUrl: './company-site-visit.component.html',
  styleUrls: ['./company-site-visit.component.css']
})
export class CompanySiteVisitComponent implements OnInit, OnChanges {
