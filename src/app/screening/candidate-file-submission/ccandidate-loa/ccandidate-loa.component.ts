...
@Component({
  standalone: false,
  selector: 'app-ccandidate-loa',
  templateUrl: './ccandidate-loa.component.html',
  styleUrls: ['./ccandidate-loa.component.css']
})
export class CcandidateLoaComponent implements OnInit {
