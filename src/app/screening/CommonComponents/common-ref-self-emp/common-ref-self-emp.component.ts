...
@Component({
  standalone: false,
  selector: 'app-common-ref-self-emp',
  templateUrl: './common-ref-self-emp.component.html',
  styleUrls: ['./common-ref-self-emp.component.css']
})

export class CommonRefSelfEmpComponent implements OnInit, OnChanges {
