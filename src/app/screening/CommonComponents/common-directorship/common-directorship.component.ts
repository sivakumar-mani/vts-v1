...
@Component({
  standalone: false,
  selector: 'app-common-directorship',
  templateUrl: './common-directorship.component.html',
  styleUrls: ['./common-directorship.component.css']
})
export class CommonDirectorshipComponent implements OnInit {
