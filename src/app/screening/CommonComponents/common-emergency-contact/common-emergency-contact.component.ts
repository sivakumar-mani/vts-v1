...
@Component({
  standalone: false,
  selector: 'app-common-emergency-contact',
  templateUrl: './common-emergency-contact.component.html',
  styleUrls: ['./common-emergency-contact.component.css']
})

export class CommonEmergencyContactComponent implements OnInit {
  compName: any;
