...
@Component({
  standalone: false,
  selector: 'app-common-database',
  templateUrl: './common-database.component.html',
  styleUrls: ['./common-database.component.css']
})
export class CommonDatabaseComponent implements OnInit {
