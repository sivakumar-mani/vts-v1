...
@Component({
  standalone: false,
  selector: 'app-common-previous-employment',
  templateUrl: './common-previous-employment.component.html',
  styleUrls: ['./common-previous-employment.component.css']
})

export class CommonPreviousEmploymentComponent implements OnInit, OnChanges {
  CFflag = 0;
  Message: any;
  disableFlag: boolean;
  naFlag = false;
  ...
  public openAddNewMasterData() {
    this.screeningService.compData = { compName: "previous-employment" }
    const popupData = {
      action: 'Employer',
