...
@Component({
  standalone: false,
  selector: 'app-common-current-employment',
  templateUrl: './common-current-employment.component.html',
  styleUrls: ['./common-current-employment.component.css']
})
export class CommonCurrentEmploymentComponent implements OnInit,OnChanges {
  CFflag = 0;
  Message: any;
  disableFlag: boolean;
  naFlag = false;
  ...
  public openAddNewMasterData() {
    this.screeningService.compData = { compName: "current-employment" }
    const popupData = {
      action: 'Employer',
