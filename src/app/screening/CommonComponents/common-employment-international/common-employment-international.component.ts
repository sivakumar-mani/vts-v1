...
@Component({
  standalone: false,
  selector: 'app-common-employment-international',
  templateUrl: './common-employment-international.component.html',
  styleUrls: ['./common-employment-international.component.css']
})
export class CommonEmploymentInternationalComponent implements OnInit, OnChanges {
  CFflag = 0;
  Message: any;
  disableFlag: boolean;
  naFlag = false;
      ...
      if (this.applicationId !== 3) {
        ...
        if (employerName) {
          ...
          if (empObj && this.empAlertCount === 0) {
            ...
            } else if ((empObj.researchStatus != this.common.VERIFIEDNUM && !this.screeningService.forResearchByPassFlag) && empObj.address.country === 'India') {
