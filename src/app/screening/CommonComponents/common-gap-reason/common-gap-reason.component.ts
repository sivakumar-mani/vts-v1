...
@Component({
  standalone: false,
  selector: 'app-common-gap-reason',
  templateUrl: './common-gap-reason.component.html',
  styleUrls: ['./common-gap-reason.component.css']
})

export class CommonGapReasonComponent implements OnInit {
