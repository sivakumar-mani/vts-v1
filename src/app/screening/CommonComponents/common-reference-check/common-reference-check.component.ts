...
@Component({
  standalone: false,
  selector: 'app-common-reference-check',
  templateUrl: './common-reference-check.component.html',
  styleUrls: ['./common-reference-check.component.css']
})

export class CommonReferenceCheckComponent implements OnInit, OnChanges {
  compName: any;
  naFlag = false;
  nFlag = false;
  ...
  ngOnInit() {
    ...
    this.showInsuff();
    this.countryList = this.screeningService.countryList;
    this.getCountryList();
    this.getRefReport();    
