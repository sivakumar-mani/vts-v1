...
@Component({
  standalone: false,
  selector: 'app-common-voderid',
  templateUrl: './common-voderid.component.html',
  styleUrls: ['./common-voderid.component.css']
})
export class CommonVoderidComponent implements  OnInit, OnChanges {
  nFlag = false;
